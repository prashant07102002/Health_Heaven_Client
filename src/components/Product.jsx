  ...
  return (
    ...
    <Card className={classes.root}>
      <Box sx={{
        ...
        <img src={product.imgHref} style={{height: '100%', objectFit: 'contain'}} alt='img'></img>
      </Box>
      <CardContent>
        <Link to={product.product_link} className={classes.cardContent} target="_blank">
        ...
        <Typography gutterBottom variant="h5" component="h2" sx={{
          ...
          {product.price}/-
          <Divider sx={{ height: 28, m: '0 0.25rem' }} orientation="vertical" />
          <Typography sx={{
            color: '#5e5e5e'
          }}>
            {product.percent_off}
